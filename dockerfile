...
ENV GODOT_APP_NAME "voip-11-2021"
ENV HTTPS_GIT_REPO ""
...
RUN godot --path /godotbuildspace --export-pack ${GODOT_EXPORT_PRESET} ${GODOT_APP_NAME}.pck
RUN mv ${GODOT_APP_NAME}.pck /godotapp/

# Change to the godotapp space, delete the source,  and run the app
WORKDIR /godotapp
run rm -f -R /godotbuildspace
CMD godot --main-pack ${GODOT_APP_NAME}.pck
